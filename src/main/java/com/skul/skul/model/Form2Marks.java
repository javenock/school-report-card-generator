...
@Entity
@Table(name = "form2marks")
public class Form2Marks {
	@Id
	...
	public Form2Marks(String form, String term, String examtype, String year, Long math, String math_grade, Long eng,
