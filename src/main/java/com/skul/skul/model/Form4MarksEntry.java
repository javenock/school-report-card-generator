...
@Entity
@Table(name = "form4marksentry")
public class Form4MarksEntry {
	@Id
	...
	public Form4MarksEntry(String form, String term, String examtype, String year, Long math, String math_grade,
