...
@Component
public class Form2SubjectRankingDaoImpl implements Form2SubjectRankingDao{

	@Autowired
	NamedParameterJdbcTemplate namedParameterJdbcTemplate;
	final String SQL_RANK_average = "SELECT regno,eng,RANK() OVER (ORDER BY eng DESC) AS eng_pos FROM form2marksreportprocess";
	final String SQL_kis_average = "SELECT regno,kis,RANK() OVER (ORDER BY kis DESC) AS kis_pos FROM form2marksreportprocess";
	final String SQL_math_average = "SELECT regno,math,RANK() OVER (ORDER BY math DESC) AS math_pos FROM form2marksreportprocess";	
	final String SQL_bio_average = "SELECT regno,bio,RANK() OVER (ORDER BY bio DESC) AS bio_pos FROM form2marksreportprocess";
	final String SQL_chem_average = "SELECT regno,chem,RANK() OVER (ORDER BY chem DESC) AS chem_pos FROM form2marksreportprocess";	
	final String SQL_phy_average = "SELECT regno,phy,RANK() OVER (ORDER BY phy DESC) AS phy_pos FROM form2marksreportprocess";	
	final String SQL_geo_average = "SELECT regno,geo,RANK() OVER (ORDER BY geo DESC) AS geo_pos FROM form2marksreportprocess";	
	final String SQL_his_average = "SELECT regno,his,RANK() OVER (ORDER BY his DESC) AS his_pos FROM form2marksreportprocess";	
	final String SQL_cre_average = "SELECT regno,cre,RANK() OVER (ORDER BY cre DESC) AS cre_pos FROM form2marksreportprocess";	
	final String SQL_agric_average = "SELECT regno,agric,RANK() OVER (ORDER BY agric DESC) AS agric_pos FROM form2marksreportprocess";	
	final String SQL_biz_average = "SELECT regno,biz,RANK() OVER (ORDER BY biz DESC) AS biz_pos FROM form2marksreportprocess";	
	final String SQL_comp_average = "SELECT regno,comp,RANK() OVER (ORDER BY comp DESC) AS comp_pos FROM form2marksreportprocess";	
	final String SQL_hom_average = "SELECT regno,hom,RANK() OVER (ORDER BY hom DESC) AS hom_pos FROM form2marksreportprocess";	
	
	final  String SQL_SELECT_TERM_ONE = "SELECT * from form2marksbackup where regno = :regno AND term = '1' ";
	 
	 final String SQL_SELECT_TERM_TWO = "SELECT * from form2marksbackup where regno = :regno AND term = '2' ";
	 
	 final String SQL_SELECT_TERM_THREE = "SELECT * from form2marksbackup where regno = :regno AND term = '3' ";
	 
     final  String SQL_SELECT_EXAM_ONE = "SELECT * from Form2backupbase where regno = :regno AND term = :term AND year = :year AND examtype = 'EXAM1' ";
	 
	 final String SQL_SELECT_EXAM_TWO = "SELECT * from Form2backupbase where regno = :regno AND term = :term AND year = :year AND examtype = 'EXAM2' ";
	 
	 final String SQL_SELECT_EXAM_THREE = "SELECT * from Form2backupbase where regno = :regno AND term = :term AND year = :year AND examtype = 'EXAM3' ";
	 
	 final  String SQL_SELECT_EXAM_ = "SELECT * from form2marksbackup where regno = :regno AND term = :term AND year = :year";
	 
	 final String SQL_DEV_ = "SELECT id,regno,COALESCE(tt,0) AS tt,tt - lag(tt) OVER (ORDER BY id) as deviation FROM form2marksbackup WHERE regno = :regno ORDER BY id DESC LIMIT 1";
		
	 final String SQL_SELECT_MARKCHIT = "SELECT student.regno,student.stream,student.fname,student.subno,student.kcpemarks,student.kcpemean,student.kcpegrade,Form2backupbase.* FROM student, Form2backupbase WHERE student.regno = Form2backupbase.regno AND Form2backupbase.term = :term AND Form2backupbase.year = :year AND Form2backupbase.examtype = :examtype ORDER BY tt DESC";
	...
	public int[] sub_rank_average(List<Form2Marks_Report_Process> subrankAvg) {
        ...
        int[] crankCounts = namedParameterJdbcTemplate.batchUpdate(
        		"update form2marksreportprocess set regno = :regno,eng_pos = :eng_pos where regno = :regno",batch);        		
        	      return crankCounts;
	}	
	@Override
	public List<Form2Marks_Report_Process> sub_rank_ave() {
		List<Form2Marks_Report_Process> list = namedParameterJdbcTemplate.query(SQL_RANK_average, new RowMapper<Form2Marks_Report_Process>() {

			@Override
			public Form2Marks_Report_Process mapRow(ResultSet rs, int rowNum) throws SQLException {
				Form2Marks_Report_Process eng_rank = new Form2Marks_Report_Process();					
	...
	public int[] sub_rank_kis(List<Form2Marks_Report_Process> subrankAvg) {
		SqlParameterSource[] batch = SqlParameterSourceUtils.createBatch(subrankAvg.toArray());  
        int[] crankCounts = namedParameterJdbcTemplate.batchUpdate(
        		"update form2marksreportprocess set regno = :regno,kis_pos = :kis_pos where regno = :regno",batch);        		
        	      return crankCounts;
	}
	@Override
	public List<Form2Marks_Report_Process> sub_rank_kis() {
		List<Form2Marks_Report_Process> list = namedParameterJdbcTemplate.query(SQL_kis_average, new RowMapper<Form2Marks_Report_Process>() {

			@Override
			public Form2Marks_Report_Process mapRow(ResultSet rs, int rowNum) throws SQLException {
				Form2Marks_Report_Process kis_rank = new Form2Marks_Report_Process();					
	...
	public int[] sub_rank_math(List<Form2Marks_Report_Process> subrankAvg) {
		SqlParameterSource[] batch = SqlParameterSourceUtils.createBatch(subrankAvg.toArray());
        int[] crankCounts = namedParameterJdbcTemplate.batchUpdate(
        		"update form2marksreportprocess set regno = :regno,math_pos = :math_pos where regno = :regno",batch);        		
        	      return crankCounts;
	}
	@Override
	public List<Form2Marks_Report_Process> sub_rank_math() {
		List<Form2Marks_Report_Process> list = namedParameterJdbcTemplate.query(SQL_math_average, new RowMapper<Form2Marks_Report_Process>() {

			@Override
			public Form2Marks_Report_Process mapRow(ResultSet rs, int rowNum) throws SQLException {
				Form2Marks_Report_Process math_rank = new Form2Marks_Report_Process();					
	...
	public int[] sub_rank_bio(List<Form2Marks_Report_Process> subrankAvg) {
		SqlParameterSource[] batch = SqlParameterSourceUtils.createBatch(subrankAvg.toArray());
        int[] crankCounts = namedParameterJdbcTemplate.batchUpdate(
        		"update form2marksreportprocess set regno = :regno,bio_pos = :bio_pos where regno = :regno",batch);        		
        	      return crankCounts;
	}
	@Override
	public List<Form2Marks_Report_Process> sub_rank_bio() {
		List<Form2Marks_Report_Process> list = namedParameterJdbcTemplate.query(SQL_bio_average, new RowMapper<Form2Marks_Report_Process>() {

			@Override
			public Form2Marks_Report_Process mapRow(ResultSet rs, int rowNum) throws SQLException {
				Form2Marks_Report_Process bio_rank = new Form2Marks_Report_Process();					
	...
	public int[] sub_rank_chem(List<Form2Marks_Report_Process> subrankAvg) {
		SqlParameterSource[] batch = SqlParameterSourceUtils.createBatch(subrankAvg.toArray());
        int[] crankCounts = namedParameterJdbcTemplate.batchUpdate(
        		"update form2marksreportprocess set regno = :regno,chem_pos = :chem_pos where regno = :regno",batch);        		
        	      return crankCounts;
	}
	@Override
	public List<Form2Marks_Report_Process> sub_rank_chem() {
		List<Form2Marks_Report_Process> list = namedParameterJdbcTemplate.query(SQL_chem_average, new RowMapper<Form2Marks_Report_Process>() {

			@Override
			public Form2Marks_Report_Process mapRow(ResultSet rs, int rowNum) throws SQLException {
				Form2Marks_Report_Process chem_rank = new Form2Marks_Report_Process();					
	...
	public int[] sub_rank_phy(List<Form2Marks_Report_Process> subrankAvg) {
		SqlParameterSource[] batch = SqlParameterSourceUtils.createBatch(subrankAvg.toArray());
        int[] crankCounts = namedParameterJdbcTemplate.batchUpdate(
        		"update form2marksreportprocess set regno = :regno,phy_pos = :phy_pos where regno = :regno",batch);        		
        	      return crankCounts;
	}
	@Override
	public List<Form2Marks_Report_Process> sub_rank_phy() {
		List<Form2Marks_Report_Process> list = namedParameterJdbcTemplate.query(SQL_phy_average, new RowMapper<Form2Marks_Report_Process>() {

			@Override
			public Form2Marks_Report_Process mapRow(ResultSet rs, int rowNum) throws SQLException {
				Form2Marks_Report_Process phy_rank = new Form2Marks_Report_Process();					
	...
	public int[] sub_rank_geo(List<Form2Marks_Report_Process> subrankAvg) {
		SqlParameterSource[] batch = SqlParameterSourceUtils.createBatch(subrankAvg.toArray());
        int[] crankCounts = namedParameterJdbcTemplate.batchUpdate(
        		"update form2marksreportprocess set regno = :regno,geo_pos = :geo_pos where regno = :regno",batch);        		
        	      return crankCounts;
	}
	@Override
	public List<Form2Marks_Report_Process> sub_rank_geo() {
		List<Form2Marks_Report_Process> list = namedParameterJdbcTemplate.query(SQL_geo_average, new RowMapper<Form2Marks_Report_Process>() {

			@Override
			public Form2Marks_Report_Process mapRow(ResultSet rs, int rowNum) throws SQLException {
				Form2Marks_Report_Process geo_rank = new Form2Marks_Report_Process();					
	...
	public int[] sub_rank_his(List<Form2Marks_Report_Process> subrankAvg) {
		SqlParameterSource[] batch = SqlParameterSourceUtils.createBatch(subrankAvg.toArray());
        int[] crankCounts = namedParameterJdbcTemplate.batchUpdate(
        		"update form2marksreportprocess set regno = :regno,his_pos = :his_pos where regno = :regno",batch);        		
        	      return crankCounts;
	}
	@Override
	public List<Form2Marks_Report_Process> sub_rank_his() {
		List<Form2Marks_Report_Process> list = namedParameterJdbcTemplate.query(SQL_his_average, new RowMapper<Form2Marks_Report_Process>() {

			@Override
			public Form2Marks_Report_Process mapRow(ResultSet rs, int rowNum) throws SQLException {
				Form2Marks_Report_Process his_rank = new Form2Marks_Report_Process();					
	...
	public int[] sub_rank_cre(List<Form2Marks_Report_Process> subrankAvg) {
		SqlParameterSource[] batch = SqlParameterSourceUtils.createBatch(subrankAvg.toArray());
        int[] crankCounts = namedParameterJdbcTemplate.batchUpdate(
        		"update form2marksreportprocess set regno = :regno,cre_pos = :cre_pos where regno = :regno",batch);        		
        	      return crankCounts;
	}
	@Override
	public List<Form2Marks_Report_Process> sub_rank_cre() {
		List<Form2Marks_Report_Process> list = namedParameterJdbcTemplate.query(SQL_cre_average, new RowMapper<Form2Marks_Report_Process>() {

			@Override
			public Form2Marks_Report_Process mapRow(ResultSet rs, int rowNum) throws SQLException {
				Form2Marks_Report_Process cre_rank = new Form2Marks_Report_Process();					
	...
	public int[] sub_rank_agric(List<Form2Marks_Report_Process> subrankAvg) {
		SqlParameterSource[] batch = SqlParameterSourceUtils.createBatch(subrankAvg.toArray());
        int[] crankCounts = namedParameterJdbcTemplate.batchUpdate(
        		"update form2marksreportprocess set regno = :regno,agric_pos = :agric_pos where regno = :regno",batch);        		
        	      return crankCounts;
	}
	@Override
	public List<Form2Marks_Report_Process> sub_rank_agric() {
		List<Form2Marks_Report_Process> list = namedParameterJdbcTemplate.query(SQL_agric_average, new RowMapper<Form2Marks_Report_Process>() {

			@Override
			public Form2Marks_Report_Process mapRow(ResultSet rs, int rowNum) throws SQLException {
				Form2Marks_Report_Process agric_rank = new Form2Marks_Report_Process();					
	...
	public int[] sub_rank_biz(List<Form2Marks_Report_Process> subrankAvg) {
		SqlParameterSource[] batch = SqlParameterSourceUtils.createBatch(subrankAvg.toArray());
        int[] crankCounts = namedParameterJdbcTemplate.batchUpdate(
        		"update form2marksreportprocess set regno = :regno,biz_pos = :biz_pos where regno = :regno",batch);        		
        	      return crankCounts;
	}
	@Override
	public List<Form2Marks_Report_Process> sub_rank_biz() {
		List<Form2Marks_Report_Process> list = namedParameterJdbcTemplate.query(SQL_biz_average, new RowMapper<Form2Marks_Report_Process>() {

			@Override
			public Form2Marks_Report_Process mapRow(ResultSet rs, int rowNum) throws SQLException {
				Form2Marks_Report_Process biz_rank = new Form2Marks_Report_Process();					
	...
	public int[] sub_rank_comp(List<Form2Marks_Report_Process> subrankAvg) {
		SqlParameterSource[] batch = SqlParameterSourceUtils.createBatch(subrankAvg.toArray());
        int[] crankCounts = namedParameterJdbcTemplate.batchUpdate(
        		"update form2marksreportprocess set regno = :regno,comp_pos = :comp_pos where regno = :regno",batch);        		
        	      return crankCounts;
	}
	@Override
	public List<Form2Marks_Report_Process> sub_rank_comp() {
		List<Form2Marks_Report_Process> list = namedParameterJdbcTemplate.query(SQL_comp_average, new RowMapper<Form2Marks_Report_Process>() {

			@Override
			public Form2Marks_Report_Process mapRow(ResultSet rs, int rowNum) throws SQLException {
				Form2Marks_Report_Process comp_rank = new Form2Marks_Report_Process();					
	...
	public int[] sub_rank_hom(List<Form2Marks_Report_Process> subrankAvg) {
		SqlParameterSource[] batch = SqlParameterSourceUtils.createBatch(subrankAvg.toArray());
        int[] crankCounts = namedParameterJdbcTemplate.batchUpdate(
        		"update form2marksreportprocess set regno = :regno,hom_pos = :hom_pos where regno = :regno",batch);        		
        	      return crankCounts;
	}
	@Override
	public List<Form2Marks_Report_Process> sub_rank_hom() {
		List<Form2Marks_Report_Process> list = namedParameterJdbcTemplate.query(SQL_hom_average, new RowMapper<Form2Marks_Report_Process>() {

			@Override
			public Form2Marks_Report_Process mapRow(ResultSet rs, int rowNum) throws SQLException {
				Form2Marks_Report_Process hom_rank = new Form2Marks_Report_Process();					
	...
	public List<Form2marksbackup> selectAll_TermOne(Long adno) {
		List<Form2marksbackup> list = namedParameterJdbcTemplate.query(SQL_SELECT_TERM_ONE, new MapSqlParameterSource().addValue("regno", adno), new RowMapper<Form2marksbackup>() {
			
				@Override
				public Form2marksbackup mapRow(ResultSet rs, int rowNum) throws SQLException {
					Form2marksbackup s_all = new Form2marksbackup();
	...
	public List<Form2marksbackup> selectAll_TermTwo(Long adno) {
		List<Form2marksbackup> list = namedParameterJdbcTemplate.query(SQL_SELECT_TERM_TWO, new MapSqlParameterSource().addValue("regno", adno), new RowMapper<Form2marksbackup>() {
	...
	public List<Form2marksbackup> selectAll_TermThree(Long adno) {
		List<Form2marksbackup> list = namedParameterJdbcTemplate.query(SQL_SELECT_TERM_THREE, new MapSqlParameterSource().addValue("regno", adno), new RowMapper<Form2marksbackup>() {
	...
	public  List<Form2Marks> selectAll_ExamOne(Long adno, String term, String year) {
		List<Form2Marks> list = namedParameterJdbcTemplate.query(SQL_SELECT_EXAM_ONE, new MapSqlParameterSource().addValue("regno", adno).addValue("term", term).addValue("year", year), new RowMapper<Form2Marks>() {
	...
	public List<Form2Marks> selectAll_ExamTwo(Long adno, String term, String year) {
		...
		List<Form2Marks> list = namedParameterJdbcTemplate.query(SQL_SELECT_EXAM_TWO, new MapSqlParameterSource().addValue("regno", adno).addValue("term", term).addValue("year", year), new RowMapper<Form2Marks>() {
	...
	public List<Form2Marks> selectAll_ExamThree(Long adno, String term,String year) {
		...
		List<Form2Marks> list = namedParameterJdbcTemplate.query(SQL_SELECT_EXAM_THREE,new MapSqlParameterSource().addValue("regno", adno).addValue("term", term).addValue("year", year), new RowMapper<Form2Marks>() {
	...
	public  List<Form2marksbackup> selectAll_Exam(Long adno, String term, String year) {
		List<Form2marksbackup> list = namedParameterJdbcTemplate.query(SQL_SELECT_EXAM_, new MapSqlParameterSource().addValue("regno", adno).addValue("term", term).addValue("year", year), new RowMapper<Form2marksbackup>() {
	...
	public List<Form2marksbackup> student_mean_dev(long regno) {
		List<Form2marksbackup> list = namedParameterJdbcTemplate.query(SQL_DEV_,new MapSqlParameterSource().addValue("regno", regno), new RowMapper<Form2marksbackup>() {
			@Override
			public Form2marksbackup mapRow(ResultSet rs, int rowNum) throws SQLException {
				Form2marksbackup s_all = new Form2marksbackup();
				s_all.setRegno(rs.getLong("regno"));
	...
	List<Form2backupbase> list = namedParameterJdbcTemplate.query(SQL_SELECT_MARKCHIT, new MapSqlParameterSource().addValue("term", term).addValue("year", year).addValue("examtype", examtype), new RowMapper<Form2backupbase>() {
			
			@Override
			public Form2backupbase mapRow(ResultSet rs, int rowNum) throws SQLException {
				Form2backupbase s_all = new Form2backupbase();
				s_all.setRegno(rs.getLong("regno"));
