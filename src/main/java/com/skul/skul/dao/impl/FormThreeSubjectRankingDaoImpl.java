...
@Component
public class FormThreeSubjectRankingDaoImpl implements FormThreeSubjectRankingDao {

	@Autowired
	NamedParameterJdbcTemplate namedParameterJdbcTemplate;
	
	
	final String SQL_RANK_average = "SELECT regno,eng,RANK() OVER (ORDER BY eng DESC) AS eng_pos FROM formthreemarksreportprocess";
	
	final String SQL_kis_average = "SELECT regno,kis,RANK() OVER (ORDER BY kis DESC) AS kis_pos FROM formthreemarksreportprocess";
	
	final String SQL_math_average = "SELECT regno,math,RANK() OVER (ORDER BY math DESC) AS math_pos FROM formthreemarksreportprocess";	
	
	final String SQL_bio_average = "SELECT regno,bio,RANK() OVER (ORDER BY bio DESC) AS bio_pos FROM formthreemarksreportprocess";
	
	final String SQL_chem_average = "SELECT regno,chem,RANK() OVER (ORDER BY chem DESC) AS chem_pos FROM formthreemarksreportprocess";	
	
	final String SQL_phy_average = "SELECT regno,phy,RANK() OVER (ORDER BY phy DESC) AS phy_pos FROM formthreemarksreportprocess";	
	
	final String SQL_geo_average = "SELECT regno,geo,RANK() OVER (ORDER BY geo DESC) AS geo_pos FROM formthreemarksreportprocess";	
	
	final String SQL_his_average = "SELECT regno,his,RANK() OVER (ORDER BY his DESC) AS his_pos FROM formthreemarksreportprocess";	
	
	final String SQL_cre_average = "SELECT regno,cre,RANK() OVER (ORDER BY cre DESC) AS cre_pos FROM formthreemarksreportprocess";	
	
	final String SQL_agric_average = "SELECT regno,agric,RANK() OVER (ORDER BY agric DESC) AS agric_pos FROM formthreemarksreportprocess";	
	
	final String SQL_biz_average = "SELECT regno,biz,RANK() OVER (ORDER BY biz DESC) AS biz_pos FROM formthreemarksreportprocess";	
	
	final String SQL_comp_average = "SELECT regno,comp,RANK() OVER (ORDER BY comp DESC) AS comp_pos FROM formthreemarksreportprocess";	
	
	final String SQL_hom_average = "SELECT regno,hom,RANK() OVER (ORDER BY hom DESC) AS hom_pos FROM formthreemarksreportprocess";
	
	final  String SQL_SELECT_EXAM_ONE = "SELECT * from Formthreebasebackup where regno = :regno AND term = :term AND year = :year AND examtype = 'EXAM1' ";
	 
	final  String SQL_SELECT_EXAM_TWO = "SELECT * from Formthreebasebackup where regno = :regno AND term = :term AND year = :year AND examtype = 'EXAM2' ";
	
	 final  String SQL_SELECT_EXAM_THREE = "SELECT * from Formthreebasebackup where regno = :regno AND term = :term AND year = :year AND examtype = 'EXAM3' ";
	 
	 final  String SQL_SELECT_EXAM_ = "SELECT * from Formthreemarksbackup where regno = :regno AND term = :term AND year = :year";
	 
	 final  String SQL_SELECT_TERM_ONE = "SELECT * from Formthreemarksbackup where regno = :regno AND term = '1' ";
	 
	 final String SQL_SELECT_TERM_TWO = "SELECT * from Formthreemarksbackup where regno = :regno AND term = '2' ";
	 
	 final String SQL_SELECT_TERM_THREE = "SELECT * from Formthreemarksbackup where regno = :regno AND term = '3' ";
	 

	final String SQL_SELECT_MARKCHIT = "SELECT student.regno,student.stream,student.fname,student.subno,student.kcpemarks,student.kcpemean,student.kcpegrade,formthreebasebackup.* FROM student, formthreebasebackup WHERE student.regno = formthreebasebackup.regno AND formthreebasebackup.term = :term AND formthreebasebackup.year = :year AND formthreebasebackup.examtype = :examtype ORDER BY tt DESC";
	...
	public int[] sub_rank_average(List<Formthreemarksreportprocess> subrankAvg) {		
        ...
        int[] crankCounts = namedParameterJdbcTemplate.batchUpdate(
        		"update formthreemarksreportprocess set regno = :regno,eng_pos = :eng_pos where regno = :regno",batch);        		
        	      return crankCounts;
	}	
	@Override
	public List<Formthreemarksreportprocess> sub_rank_ave() {
		List<Formthreemarksreportprocess> list = namedParameterJdbcTemplate.query(SQL_RANK_average, new RowMapper<Formthreemarksreportprocess>() {
			@Override
			public Formthreemarksreportprocess mapRow(ResultSet rs, int rowNum) throws SQLException {
				Formthreemarksreportprocess eng_rank = new Formthreemarksreportprocess();					
	...
	public int[] sub_rank_kis(List<Formthreemarksreportprocess> subrankAvg) {
		SqlParameterSource[] batch = SqlParameterSourceUtils.createBatch(subrankAvg.toArray());  
        int[] crankCounts = namedParameterJdbcTemplate.batchUpdate(
        		"update formthreemarksreportprocess set regno = :regno,kis_pos = :kis_pos where regno = :regno",batch);        		
        	      return crankCounts;
	}
	@Override
	public List<Formthreemarksreportprocess> sub_rank_kis() {
		List<Formthreemarksreportprocess> list = namedParameterJdbcTemplate.query(SQL_kis_average, new RowMapper<Formthreemarksreportprocess>() {

			@Override
			public Formthreemarksreportprocess mapRow(ResultSet rs, int rowNum) throws SQLException {
				Formthreemarksreportprocess kis_rank = new Formthreemarksreportprocess();					
	...
	public int[] sub_rank_math(List<Formthreemarksreportprocess> subrankAvg) {
		SqlParameterSource[] batch = SqlParameterSourceUtils.createBatch(subrankAvg.toArray());
        int[] crankCounts = namedParameterJdbcTemplate.batchUpdate(
        		"update formthreemarksreportprocess set regno = :regno,math_pos = :math_pos where regno = :regno",batch);        		
        	      return crankCounts;
	}
	@Override
	public List<Formthreemarksreportprocess> sub_rank_math() {
		List<Formthreemarksreportprocess> list = namedParameterJdbcTemplate.query(SQL_math_average, new RowMapper<Formthreemarksreportprocess>() {

			@Override
			public Formthreemarksreportprocess mapRow(ResultSet rs, int rowNum) throws SQLException {
				Formthreemarksreportprocess math_rank = new Formthreemarksreportprocess();					
	...
	public int[] sub_rank_bio(List<Formthreemarksreportprocess> subrankAvg) {
		SqlParameterSource[] batch = SqlParameterSourceUtils.createBatch(subrankAvg.toArray());
        int[] crankCounts = namedParameterJdbcTemplate.batchUpdate(
        		"update formthreemarksreportprocess set regno = :regno,bio_pos = :bio_pos where regno = :regno",batch);        		
        	      return crankCounts;
	}
	@Override
	public List<Formthreemarksreportprocess> sub_rank_bio() {
		List<Formthreemarksreportprocess> list = namedParameterJdbcTemplate.query(SQL_bio_average, new RowMapper<Formthreemarksreportprocess>() {

			@Override
			public Formthreemarksreportprocess mapRow(ResultSet rs, int rowNum) throws SQLException {
				Formthreemarksreportprocess bio_rank = new Formthreemarksreportprocess();					
	...
	public int[] sub_rank_chem(List<Formthreemarksreportprocess> subrankAvg) {
		SqlParameterSource[] batch = SqlParameterSourceUtils.createBatch(subrankAvg.toArray());
        int[] crankCounts = namedParameterJdbcTemplate.batchUpdate(
        		"update formthreemarksreportprocess set regno = :regno,chem_pos = :chem_pos where regno = :regno",batch);        		
        	      return crankCounts;
	}
	@Override
	public List<Formthreemarksreportprocess> sub_rank_chem() {
		List<Formthreemarksreportprocess> list = namedParameterJdbcTemplate.query(SQL_chem_average, new RowMapper<Formthreemarksreportprocess>() {

			@Override
			public Formthreemarksreportprocess mapRow(ResultSet rs, int rowNum) throws SQLException {
				Formthreemarksreportprocess chem_rank = new Formthreemarksreportprocess();					
	...
	public int[] sub_rank_phy(List<Formthreemarksreportprocess> subrankAvg) {
		SqlParameterSource[] batch = SqlParameterSourceUtils.createBatch(subrankAvg.toArray());
        int[] crankCounts = namedParameterJdbcTemplate.batchUpdate(
        		"update formthreemarksreportprocess set regno = :regno,phy_pos = :phy_pos where regno = :regno",batch);        		
        	      return crankCounts;
	}
	@Override
	public List<Formthreemarksreportprocess> sub_rank_phy() {
		List<Formthreemarksreportprocess> list = namedParameterJdbcTemplate.query(SQL_phy_average, new RowMapper<Formthreemarksreportprocess>() {

			@Override
			public Formthreemarksreportprocess mapRow(ResultSet rs, int rowNum) throws SQLException {
				Formthreemarksreportprocess phy_rank = new Formthreemarksreportprocess();					
	...
	public int[] sub_rank_geo(List<Formthreemarksreportprocess> subrankAvg) {
		SqlParameterSource[] batch = SqlParameterSourceUtils.createBatch(subrankAvg.toArray());
        int[] crankCounts = namedParameterJdbcTemplate.batchUpdate(
        		"update formthreemarksreportprocess set regno = :regno,geo_pos = :geo_pos where regno = :regno",batch);        		
        	      return crankCounts;
	}
	@Override
	public List<Formthreemarksreportprocess> sub_rank_geo() {
		List<Formthreemarksreportprocess> list = namedParameterJdbcTemplate.query(SQL_geo_average, new RowMapper<Formthreemarksreportprocess>() {

			@Override
			public Formthreemarksreportprocess mapRow(ResultSet rs, int rowNum) throws SQLException {
				Formthreemarksreportprocess geo_rank = new Formthreemarksreportprocess();					
	...
	public int[] sub_rank_his(List<Formthreemarksreportprocess> subrankAvg) {
		SqlParameterSource[] batch = SqlParameterSourceUtils.createBatch(subrankAvg.toArray());
        int[] crankCounts = namedParameterJdbcTemplate.batchUpdate(
        		"update formthreemarksreportprocess set regno = :regno,his_pos = :his_pos where regno = :regno",batch);        		
        	      return crankCounts;
	}
	@Override
	public List<Formthreemarksreportprocess> sub_rank_his() {
		List<Formthreemarksreportprocess> list = namedParameterJdbcTemplate.query(SQL_his_average, new RowMapper<Formthreemarksreportprocess>() {

			@Override
			public Formthreemarksreportprocess mapRow(ResultSet rs, int rowNum) throws SQLException {
				Formthreemarksreportprocess his_rank = new Formthreemarksreportprocess();					
	...
	public int[] sub_rank_cre(List<Formthreemarksreportprocess> subrankAvg) {
		SqlParameterSource[] batch = SqlParameterSourceUtils.createBatch(subrankAvg.toArray());
        int[] crankCounts = namedParameterJdbcTemplate.batchUpdate(
        		"update formthreemarksreportprocess set regno = :regno,cre_pos = :cre_pos where regno = :regno",batch);        		
        	      return crankCounts;
	}
	@Override
	public List<Formthreemarksreportprocess> sub_rank_cre() {
		List<Formthreemarksreportprocess> list = namedParameterJdbcTemplate.query(SQL_cre_average, new RowMapper<Formthreemarksreportprocess>() {

			@Override
			public Formthreemarksreportprocess mapRow(ResultSet rs, int rowNum) throws SQLException {
				Formthreemarksreportprocess cre_rank = new Formthreemarksreportprocess();					
	...
	public int[] sub_rank_agric(List<Formthreemarksreportprocess> subrankAvg) {
		SqlParameterSource[] batch = SqlParameterSourceUtils.createBatch(subrankAvg.toArray());
        int[] crankCounts = namedParameterJdbcTemplate.batchUpdate(
        		"update formthreemarksreportprocess set regno = :regno,agric_pos = :agric_pos where regno = :regno",batch);        		
        	      return crankCounts;
	}
	@Override
	public List<Formthreemarksreportprocess> sub_rank_agric() {
		List<Formthreemarksreportprocess> list = namedParameterJdbcTemplate.query(SQL_agric_average, new RowMapper<Formthreemarksreportprocess>() {

			@Override
			public Formthreemarksreportprocess mapRow(ResultSet rs, int rowNum) throws SQLException {
				Formthreemarksreportprocess agric_rank = new Formthreemarksreportprocess();					
	...
	public int[] sub_rank_biz(List<Formthreemarksreportprocess> subrankAvg) {
		SqlParameterSource[] batch = SqlParameterSourceUtils.createBatch(subrankAvg.toArray());
        int[] crankCounts = namedParameterJdbcTemplate.batchUpdate(
        		"update formthreemarksreportprocess set regno = :regno,biz_pos = :biz_pos where regno = :regno",batch);        		
        	      return crankCounts;
	}
	@Override
	public List<Formthreemarksreportprocess> sub_rank_biz() {
		List<Formthreemarksreportprocess> list = namedParameterJdbcTemplate.query(SQL_biz_average, new RowMapper<Formthreemarksreportprocess>() {

			@Override
			public Formthreemarksreportprocess mapRow(ResultSet rs, int rowNum) throws SQLException {
				Formthreemarksreportprocess biz_rank = new Formthreemarksreportprocess();					
	...
	public int[] sub_rank_comp(List<Formthreemarksreportprocess> subrankAvg) {
		SqlParameterSource[] batch = SqlParameterSourceUtils.createBatch(subrankAvg.toArray());
        int[] crankCounts = namedParameterJdbcTemplate.batchUpdate(
        		"update formthreemarksreportprocess set regno = :regno,comp_pos = :comp_pos where regno = :regno",batch);        		
        	      return crankCounts;
	}
	@Override
	public List<Formthreemarksreportprocess> sub_rank_comp() {
		List<Formthreemarksreportprocess> list = namedParameterJdbcTemplate.query(SQL_comp_average, new RowMapper<Formthreemarksreportprocess>() {

			@Override
			public Formthreemarksreportprocess mapRow(ResultSet rs, int rowNum) throws SQLException {
				Formthreemarksreportprocess comp_rank = new Formthreemarksreportprocess();					
	...
	public int[] sub_rank_hom(List<Formthreemarksreportprocess> subrankAvg) {
		SqlParameterSource[] batch = SqlParameterSourceUtils.createBatch(subrankAvg.toArray());
        int[] crankCounts = namedParameterJdbcTemplate.batchUpdate(
        		"update formthreemarksreportprocess set regno = :regno,hom_pos = :hom_pos where regno = :regno",batch);        		
        	      return crankCounts;
	}
	@Override
	public List<Formthreemarksreportprocess> sub_rank_hom() {
		List<Formthreemarksreportprocess> list = namedParameterJdbcTemplate.query(SQL_hom_average, new RowMapper<Formthreemarksreportprocess>() {

			@Override
			public Formthreemarksreportprocess mapRow(ResultSet rs, int rowNum) throws SQLException {
				Formthreemarksreportprocess hom_rank = new Formthreemarksreportprocess();					
	...
	public  List<Formthreebasebackup> selectAll_ExamOne(Long adno, String term, String year) {
		List<Formthreebasebackup> list = namedParameterJdbcTemplate.query(SQL_SELECT_EXAM_ONE, new MapSqlParameterSource().addValue("regno", adno).addValue("term", term).addValue("year", year), new RowMapper<Formthreebasebackup>() {
	...
	public  List<Formthreebasebackup> selectAll_ExamTwo(Long adno, String term, String year) {
		List<Formthreebasebackup> list = namedParameterJdbcTemplate.query(SQL_SELECT_EXAM_TWO, new MapSqlParameterSource().addValue("regno", adno).addValue("term", term).addValue("year", year), new RowMapper<Formthreebasebackup>() {
	...
	public  List<Formthreebasebackup> selectAll_ExamThree(Long adno, String term, String year) {
		List<Formthreebasebackup> list = namedParameterJdbcTemplate.query(SQL_SELECT_EXAM_THREE, new MapSqlParameterSource().addValue("regno", adno).addValue("term", term).addValue("year", year), new RowMapper<Formthreebasebackup>() {
	...
	public  List<Formthreemarksbackup> selectAll_Exam(Long adno, String term, String year) {
		List<Formthreemarksbackup> list = namedParameterJdbcTemplate.query(SQL_SELECT_EXAM_, new MapSqlParameterSource().addValue("regno", adno).addValue("term", term).addValue("year", year), new RowMapper<Formthreemarksbackup>() {
			
			@Override
			public Formthreemarksbackup mapRow(ResultSet rs, int rowNum) throws SQLException {
				Formthreemarksbackup s_all = new Formthreemarksbackup();
				s_all.setRegno(rs.getLong("regno"));
				s_all.setForm(rs.getString("form"));
				s_all.setTerm(rs.getString("term"));
				s_all.setYear(rs.getString("year"));
	...
	public List<Formthreemarksbackup> selectAll_TermOne(Long adno) {
		List<Formthreemarksbackup> list = namedParameterJdbcTemplate.query(SQL_SELECT_TERM_ONE, new MapSqlParameterSource().addValue("regno", adno), new RowMapper<Formthreemarksbackup>() {
	...
	public List<Formthreemarksbackup> selectAll_TermTwo(Long adno) {
		List<Formthreemarksbackup> list = namedParameterJdbcTemplate.query(SQL_SELECT_TERM_TWO, new MapSqlParameterSource().addValue("regno", adno), new RowMapper<Formthreemarksbackup>() {
	...
	public List<Formthreemarksbackup> selectAll_TermThree(Long adno) {
		List<Formthreemarksbackup> list = namedParameterJdbcTemplate.query(SQL_SELECT_TERM_THREE, new MapSqlParameterSource().addValue("regno", adno), new RowMapper<Formthreemarksbackup>() {
	...
	List<Formthreebasebackup> list = namedParameterJdbcTemplate.query(SQL_SELECT_MARKCHIT, new MapSqlParameterSource().addValue("term", term).addValue("year", year).addValue("examtype", examtype), new RowMapper<Formthreebasebackup>() {
	...
	public List<Formthreemarksbackup> student_mean_dev(long regno) {
		List<Formthreemarksbackup> list = namedParameterJdbcTemplate.query(SQL_DEV_,new MapSqlParameterSource().addValue("regno", regno), new RowMapper<Formthreemarksbackup>() {
			@Override
			public Formthreemarksbackup mapRow(ResultSet rs, int rowNum) throws SQLException {
				Formthreemarksbackup s_all = new Formthreemarksbackup();
				s_all.setRegno(rs.getLong("regno"));
