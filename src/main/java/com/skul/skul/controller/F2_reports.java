...
@RequestMapping("/tworeport")
@Controller
public class F2_reports {
	...
	@RequestMapping(value = "/two_reports/{year}/{term}", method = RequestMethod.GET,produces = MediaType.APPLICATION_PDF_VALUE)
    public ResponseEntity<InputStreamResource> threeReport(@PathVariable String term, @PathVariable String year) throws DocumentException, MalformedURLException, IOException {
        ByteArrayInputStream bis = two_Report(term, year);
        HttpHeaders  headers = new HttpHeaders();
        headers.add("Content-Disposition", "inline; filename=form_TWO_report_pdf.pdf");
	...
	@GetMapping(value = "/two_reports")
	public String getTerm_year(@ModelAttribute("term") String term,@ModelAttribute("year") String year, Model model) {
	return "redirect:/tworeport/two_reports/" + year +"/" + term ;          
	    
	}
public ByteArrayInputStream two_Report(@PathVariable String term,@PathVariable String year) throws DocumentException, MalformedURLException, IOException {
        ...
        String trm = "";
         ...
         PdfWriter writer = PdfWriter.getInstance(document, out);
		  document.open();
             ...
             List<Student> noStudents = studentService.getAllStudent_form_two();
            ...
            // try { 
            	 for(Student stdd : noStudents ) {
                	 ...
                	 document.newPage();
                	  String eng = "--";String kis = "--";String math = "--";String bio = "--";String chem = "--";
           			...
           			String f1_exam_tt_one = "0"; String f1_exam_points_one ="0"; String f1_exam_mean_one ="0"; String f1_exam_op_one ="0";
           			String f1_exam_tt_two = "0"; String f1_exam_points_two ="0"; String f1_exam_mean_two ="0"; String f1_exam_op_two ="0";
           			String f1_exam_tt_three = "0"; String f1_exam_points_three ="0"; String f1_exam_mean_three ="0"; String f1_exam_op_three ="0";
           		...
           		List<Form2Marks> exm1 = form2SubjectRankingService.selectAll_ExamOne(stdd.getRegno(),term,year);		
           		for (Form2Marks markss : exm1) {
            	...
            	if((markss.getAvg()==0)) {}else {
           		...
           		List<Form2Marks> exam2 = form2SubjectRankingService.selectAll_ExamTwo(stdd.getRegno(),term,year);
           		for (Form2Marks marksss : exam2) {
           	...
           	if((marksss.getAvg()==0)) {}else {
           		...
           		List<Form2Marks> exam3 = form2SubjectRankingService.selectAll_ExamThree(stdd.getRegno(),term,year);
           		for (Form2Marks markssss : exam3) {
           	...
           	if((markssss.getAvg()==0)) {}else {
           		...
           		List<Form2marksbackup> exm = form2SubjectRankingService.selectAll_Exam(stdd.getRegno(),term,year);		
           		for (Form2marksbackup mark : exm) {
           	...
           	if((mark.getTt()==0)) {}else {
           		...
           		//form 1
           		List<FormOneMarksBackUp> f1_exam = formOneSubjectRankingService.selectAll_TermOne(stdd.getRegno());
           		for (FormOneMarksBackUp exam_mark : f1_exam) {
          			 f1_exam_tt_one = Long.toString(exam_mark.getTt());  f1_exam_points_one = Long.toString(exam_mark.getPoints());  f1_exam_mean_one = exam_mark.getOv_grade();  f1_exam_op_one = exam_mark.getRank();
           	           	}
           		List<FormOneMarksBackUp> f1_exam_two = formOneSubjectRankingService.selectAll_TermTwo(stdd.getRegno());
           		for (FormOneMarksBackUp exam_mar : f1_exam_two) {
           			f1_exam_tt_two = Long.toString(exam_mar.getTt());  f1_exam_points_two = Long.toString(exam_mar.getPoints());  f1_exam_mean_two = exam_mar.getOv_grade();  f1_exam_op_two = exam_mar.getRank();
           	           	}
           		List<FormOneMarksBackUp> f1_exam_three = formOneSubjectRankingService.selectAll_TermThree(stdd.getRegno());
           		for (FormOneMarksBackUp exam_ma : f1_exam_three) {
           			f1_exam_tt_three = Long.toString(exam_ma.getTt());  f1_exam_points_three = Long.toString(exam_ma.getPoints());  f1_exam_mean_three = exam_ma.getOv_grade();  f1_exam_op_three = exam_ma.getRank();
           	           	}
           		// form 2
           		List<Form2marksbackup> exam = form2SubjectRankingService.selectAll_TermOne(stdd.getRegno());
           		for (Form2marksbackup exam_mark : exam) {
           		...
           		List<Form2marksbackup> exam_two = form2SubjectRankingService.selectAll_TermTwo(stdd.getRegno());
           		for (Form2marksbackup exam_mar : exam_two) {
           		...
           		List<Form2marksbackup> exam_three = form2SubjectRankingService.selectAll_TermThree(stdd.getRegno());
           		for (Form2marksbackup exam_ma : exam_three) {
           		...
           		List<Form2marksbackup> std_mean = form2SubjectRankingService.student_mean_dev(stdd.getRegno());
           		for (Form2marksbackup student_dev : std_mean) {
           			 devtion = student_dev.getDev();
           		}
           		
           		
           		DefaultCategoryDataset chart =new DefaultCategoryDataset();
           		double t1 = 0.0;  double f1t1 = 0.0; double f1t2 = 0.0; double f1t3 = 0.0; 
           		double t2 = 0.0; 
           		double t3 = 0.0; 		
           		f1t1 = Double.parseDouble(f1_exam_points_one);
           		f1t2 = Double.parseDouble(f1_exam_points_two);
           		f1t3 = Double.parseDouble(f1_exam_points_three);
          		 
           		 t1 = Double.parseDouble(exam_points_one);
           		 t2 = Double.parseDouble(exam_points_two);
           		 t3 = Double.parseDouble(exam_points_three);
                  chart.setValue(f1t1,"Marks","F1T1"); 
                  chart.setValue(f1t2,"Marks","F1T2"); 
                  chart.setValue(f1t3,"Marks","F1T3");
                  
                  chart.setValue(t1,"Marks","F2T1");
                  chart.setValue(t2,"Marks","F2T2"); 
                  chart.setValue(t3,"Marks","F2T3"); 
                  ...
                  Font fonth1 = FontFactory.getFont(FontFactory.COURIER,9);
                   ...
                   table_PERF.addCell(new PdfPCell(new Phrase(f1_exam_tt_one,fonth_P)));
                   table_PERF.addCell(new PdfPCell(new Phrase(f1_exam_points_one,fonth_P)));
                   table_PERF.addCell(new PdfPCell(new Phrase(f1_exam_mean_one,fonth_P)));
                   table_PERF.addCell(new PdfPCell(new Phrase(f1_exam_op_one,fonth_P)));
                   ...
                   table_PERF.addCell(new PdfPCell(new Phrase(f1_exam_tt_two,fonth_P)));
                   table_PERF.addCell(new PdfPCell(new Phrase(f1_exam_points_two,fonth_P)));
                   table_PERF.addCell(new PdfPCell(new Phrase(f1_exam_mean_two,fonth_P)));
                   table_PERF.addCell(new PdfPCell(new Phrase(f1_exam_op_two,fonth_P)));
                   ...
                   table_PERF.addCell(new PdfPCell(new Phrase(f1_exam_tt_three,fonth_P)));
                   table_PERF.addCell(new PdfPCell(new Phrase(f1_exam_points_three,fonth_P)));
                   table_PERF.addCell(new PdfPCell(new Phrase(f1_exam_mean_three,fonth_P)));
                   table_PERF.addCell(new PdfPCell(new Phrase(f1_exam_op_three,fonth_P)));
