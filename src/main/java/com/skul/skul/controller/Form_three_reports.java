...
@RequestMapping("/f3_reports")
@Controller
public class Form_three_reports {
	@Autowired
	...
	@RequestMapping(value = "/three_reports/{year}/{term}", method = RequestMethod.GET,produces = MediaType.APPLICATION_PDF_VALUE)
    public ResponseEntity<InputStreamResource> threeReport(@PathVariable String term, @PathVariable String year) throws DocumentException, MalformedURLException, IOException {
        ByteArrayInputStream bis = three_Report(term, year);
        HttpHeaders  headers = new HttpHeaders();
        headers.add("Content-Disposition", "inline; filename=form_three_report_pdf.pdf");
	...
	@GetMapping(value = "/three_reports")
	public String getTerm_year(@ModelAttribute("term") String term,@ModelAttribute("year") String year, Model model) {
	return "redirect:/f3_reports/three_reports/" + year +"/" + term ;          
	    
	}
	
public ByteArrayInputStream three_Report(@PathVariable String term,@PathVariable String year) throws DocumentException, MalformedURLException, IOException {
        ...
        String trm = "";
         ...
         PdfWriter writer = PdfWriter.getInstance(document, out);
		  document.open();
             ...
             List<Student> noStudents = studentService.getAllStudent_form_Three();
            ...
            // try { 
         		...
         		List<Formthreebasebackup> exm1 = formThreeSubjectRankingService.selectAll_ExamOne(stdd.getRegno(),term,year);		
         		for (Formthreebasebackup markss : exm1) {
         	...
         	eng1_grade = markss.getEng_grade();kis1_grade = markss.getKis_grade();	math1_grade = markss.getMath_grade();       	
         		...
         		List<Formthreebasebackup> exam2 = formThreeSubjectRankingService.selectAll_ExamTwo(stdd.getRegno(),term,year);
         		for (Formthreebasebackup marksss : exam2) {
         	...
         	crank2 = marksss.getCrank(); rank2 = marksss.getRank();
         		...
         		List<Formthreebasebackup> exam3 = formThreeSubjectRankingService.selectAll_ExamThree(stdd.getRegno(),term,year);
         		for (Formthreebasebackup markssss : exam3) {
         	...
         	if((markssss.getPoints()==0)) {}else {
         		...
         		List<Formthreemarksbackup> exm = formThreeSubjectRankingService.selectAll_Exam(stdd.getRegno(),term,year);		
         		for (Formthreemarksbackup mark : exm) {
         	...
         	// form 2
         		...
         		List<Formthreemarksbackup> exam = formThreeSubjectRankingService.selectAll_TermOne(stdd.getRegno());
         		for (Formthreemarksbackup exam_mark : exam) {
         		...
         		List<Formthreemarksbackup> exam_two = formThreeSubjectRankingService.selectAll_TermTwo(stdd.getRegno());
         		for (Formthreemarksbackup exam_mar : exam_two) {
         		...
         		List<Formthreemarksbackup> exam_three = formThreeSubjectRankingService.selectAll_TermThree(stdd.getRegno());
         		for (Formthreemarksbackup exam_ma : exam_three) {
         		...
         		List<Formthreemarksbackup> std_mean = formThreeSubjectRankingService.student_mean_dev(stdd.getRegno());
         		for (Formthreemarksbackup student_dev : std_mean) {
         			 devtion = student_dev.getDev();
         		}
         		DefaultCategoryDataset chart =new DefaultCategoryDataset();
         	
         		double t1_f1 = 0.0;  double t1_f2 = 0.0;  double t2_f2 = 0.0;  double t3_f2 = 0.0;
         		double t2_f1 = 0.0;
         		double t3_f1 = 0.0;     		
         		double t1 = 0.0;
         		double t2 = 0.0;
                ...
                chart.setValue(t1,"Marks","F3T1");
                chart.setValue(t2,"Marks","F3T2");
                chart.setValue(t3,"Marks","F3T3"); 
                ...
                my2DChart.setTitle(mm);
                 ...
                 Image img = Image.getInstance(Form_three_reports.class.getResource("/images.jpg"));
                 ...
                 Image img2 = Image.getInstance(Form_three_reports.class.getResource("/male3-128.png"));
                ...
                Font fonth1 = FontFactory.getFont(FontFactory.TIMES_BOLD,9);
                 ...
                 document.add(table_PERF);
                     ...
                     Rectangle2D Chart_Region=new Rectangle2D.Double(25,2,530,150); //25,<left; 150 height;
